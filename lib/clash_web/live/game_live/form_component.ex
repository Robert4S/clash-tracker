defmodule ClashWeb.GameLive.FormComponent do
  use ClashWeb, :live_component
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:my_crowns]} type="number" label="My crowns" />
        <.input field={@form[:opponent_crowns]} type="number" label="Opponent crowns" />
