defmodule ClashWeb.GameLiveTest do
  use ClashWeb.ConnCase

  import Phoenix.LiveViewTest
  import Clash.GamesFixtures

  @create_attrs %{date: "2024-11-12T19:11:00Z", opponent: "some opponent", my_crowns: 42, opponent_crowns: 42}
  @update_attrs %{date: "2024-11-13T19:11:00Z", opponent: "some updated opponent", my_crowns: 43, opponent_crowns: 43}
  ...
  describe "Index" do
    ...
    test "updates game in listing", %{conn: conn, game: game} do
      ...
      assert html =~ "some updated opponent"
    end
